              ...
              <div className="p-6">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="flex-1 bg-gray-800 dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 text-white font-bold py-2 px-4 rounded text-center transition duration-300"
                  >
                    GitHub
                  </a>
                  {project.demo && (
